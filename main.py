...
def main():
    ...
    rates1 = [16, -3, 0.2, 0, -3, -1, 0, 0, 0.2, 0, 0, 0, 0, 0, 0, 0, 1, 16, 320, 1, 1]
    rates2 = [16, -3, 0.2, 0, -3, -1, 0, 0, 0.2, 0, 0, 0, 0, 0, 0, 0, 1, 16, 1, 1, 1]
    start(rates1, rates2)
...
def start(rates1, rates2):
    ...
    new_round = game(0x1c0000100000, 0x203e1c080000, 'black')
    new_round = game(0xc181c080800, 0x224620141000, 'black')
    new_round = game()
